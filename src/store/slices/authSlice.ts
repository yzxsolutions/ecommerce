...
const authSlice = createSlice({
  ...
  reducers: {
    ...
    setAuthState: (state, action: PayloadAction<{ user: User; accessToken: string }>) => {
...
export const { clearError, setAccessToken, clearAuth, setAuthState, setLoading } = authSlice.actions;
